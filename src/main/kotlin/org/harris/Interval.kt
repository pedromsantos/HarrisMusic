...
enum class Interval(private val intervalName: String, private val abreviature: String, private val distance: Int, private val naturalDistance: Int, private val transposeValue: Int) {
    ...
    AugmentedUnison("AugmentedUnison", "A1", 1, C.naturalDistance(C), 1),
    MinorSecond("MinorSecond", "m2", 1, C.naturalDistance(D), 2),
    MajorSecond("MajorSecond", "M2", 2, C.naturalDistance(D), 3),
    AugmentedSecond("AugmentedSecond", "A2", 3, C.naturalDistance(D),4),
    MinorThird("MinorThird", "m3", 3, C.naturalDistance(E), 5),
    MajorThird("MajorThird", "M3", 4, C.naturalDistance(E), 6),
    PerfectFourth("PerfectFourth", "P4", 5, C.naturalDistance(F), 7),
    AugmentedFourth("AugmentedFourth", "A4", 6, C.naturalDistance(F), 8),
    DiminishedFifth("DiminishedFifth", "d5", 6, C.naturalDistance(G), 9),
    Tritone("DiminishedFifth", "d5", 6, C.naturalDistance(G), 9),
    PerfectFifth("PerfectFifth", "P5", 7, C.naturalDistance(G), 10),
    AugmentedFifth("AugmentedFifth", "A5", 8, C.naturalDistance(G), 11),
    MinorSixth("MinorSixth", "m6", 8, C.naturalDistance(A), 12),
    MajorSixth("MajorSixth", "M6", 9, C.naturalDistance(A), 13),
    DiminishedSeventh("DiminishedSeventh", "d7", 9, C.naturalDistance(B), 13),
    MinorSeventh("MinorSeventh", "m7", 10, C.naturalDistance(B), 15),
    MajorSeventh("MajorSeventh", "M7", 11, C.naturalDistance(B), 16),
    PerfectOctave("PerfectOctave", "PO", 12, C.naturalDistance(C), 17),
    MinorNinth("MinorNinth", "m9", 13, C.naturalDistance(D), 19),
    MajorNinth("MajorNinth", "M9", 14, C.naturalDistance(D), 20),
    AugmentedNinth("AugmentedNinth", "A9", 15, C.naturalDistance(D), 21),
    PerfectEleventh("PerfectEleventh", "P11", 17, C.naturalDistance(F), 24),
    AugmentedEleventh("AugmentedEleventh", "A11", 18, C.naturalDistance(F), 25),
    MinorThirteenth("MinorThirteenth", "m13", 20, C.naturalDistance(A), 29),
